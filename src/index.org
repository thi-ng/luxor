...
exporter for [[http://luxcorerender.org][Luxrender]] (v1.3+), an open source, physically based and
...
https://web.archive.org/web/20160422052811/http://www.luxrender.net/wiki/Scene_file_format_dev
...
#+BEGIN_SRC clojure :tangle ../babel/examples/test-scene.clj :mkdirp yes :padline no
  ...
  ;; http://www.luxcorerender.org/wiki/Scene_file_format_dev
